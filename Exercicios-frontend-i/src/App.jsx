...
function App() {
  ...
  const listaNum = [2, 6, 10, 1, 5, 7, 12, 13, 15, 20, 24, 31];
  ...
  return (
    <div className="App" >
      ...
      <span> 10.Crie um componente chamado 'VerificarIdade' que aceita uma prop chamada
        ...
        "xx anos, é maior de idade" se a idade for maior ou igual a 18, em uma div
          ...
          <VerificarIdade idade={14} />
          <hr />

          <span> 11.Crie um componente chamado 'NumerosPares' que aceita uma prop chamada
          ...
          <NumerosPares numeros={listaNum} />
          <hr />

          <span> 12.Crie um componente chamado 'NumerosImpares' que aceita uma prop chamada
            'numeros' e deve ser uma lista de números inteiros.
          ...
          <NumerosImpares numeros={listaNum} />
          <hr />

          <span> 13.Crie um componente chamado 'Soma' que aceita as props 'num1', 'num2', o
          ...
          <span> 14.Crie um componente chamado 'Subtracao' que aceita as props 'num1', 'num2', o
            componente deve mostrar:
          ...
          <span> 15.Crie um componente chamado 'Divisao' que aceita as props 'num1', 'num2', o
            componente deve mostrar:
          ...
          <span> 16.Crie um componente chamado 'Multiplicacao' que aceita as props 'num1', 'num2',
          ...
          <span> 17.Crie um componente chamado 'Calculadora' que aceita as props 'num1', 'num2' e
          ...
          <span> 18.Crie um componente chamado 'TamanhoTexto' que aceita uma prop chamado
          ...
          <TamanhoTexto texto="O texto possui 112 caracteres." />
          <hr />

          <span> 19.Crie um componente chamado 'NomesOrdenados' que aceita uma prop
          ...
          <NomesOrdenados nomes={listaNomes} />
    <hr />
